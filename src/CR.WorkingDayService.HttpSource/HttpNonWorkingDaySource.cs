...
namespace CR.WorkingDayService.HttpSource
{
    ...
    /// <summary>
    /// An implementation of <see cref="StringNonWorkingDaySource{T}"/> which uses the returned content of a HTTP Endpoint as the source for determining if a <see cref="DateTime"/> is on a Working Day.
    /// </summary>
