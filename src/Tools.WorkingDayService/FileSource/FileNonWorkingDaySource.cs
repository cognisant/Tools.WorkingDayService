...
#pragma warning disable SA1648 // inheritdoc should be used with inheriting class
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="FileNonWorkingDaySource{T}"/> class with a <see cref="FileSystemWatcher"/> that watches the file at the provided file path and updates it's internal state with any new content.
